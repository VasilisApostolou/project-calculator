...
class Calculator_App():
      ...
      def create_buttons_grid(self):
            ...
            button_0 = tk.Button(button_frame, text='0', **button_options)
      ...
      def create_entry_box(self):
            entry_box = tk.Entry(self.w, justify='right', bg="#232323",fg='white', font=("Arial", 32))
            entry_box.pack(fill="x",padx=10, pady=10, ipadx=8, ipady=8)
