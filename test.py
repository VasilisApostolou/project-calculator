...
class Calculator_App():
        ...
        def create_buttons_grid(self):
                ...
                button_e = tk.Button(button_frame,text="e",**button_options)
                button_π = tk.Button(button_frame,text="π",**button_options)
                button_xʸ=tk.Button(button_frame,text="xʸ",**button_options)
                button_bin = tk.Button(button_frame,text="Bin",**button_options)
                button_oct = tk.Button(button_frame,text="Oct",**button_options)
                button_hex = tk.Button(button_frame,text="Hex",**button_options)
                button_par1 = tk.Button(button_frame, text='(', **button_options)
                button_par = tk.Button(button_frame, text=')', **button_options)
                button_ln = tk.Button(button_frame,text="ln",**button_options)
                button_mod = tk.Button(button_frame,text="mod", **button_options)
                button_gamma = tk.Button(button_frame, text="Γ(z)",**button_options)
                button_exp = tk.Button(button_frame, text="exp",**button_options)
                button_sinh = tk.Button(button_frame, text="sinh",**button_options)
                button_cosh = tk.Button(button_frame, text="cosh",**button_options)
                button_tanh = tk.Button(button_frame, text="tanh",**button_options)
        ...
        def exit_calc(self):
                users_response = messagebox.askquestion("EXIT","Are you sure you want to exit the program?")
        ...
        def create_option_menu(self):
                ...
                self.option_menu.add_command(label="Programmer", command=self.programmer)
